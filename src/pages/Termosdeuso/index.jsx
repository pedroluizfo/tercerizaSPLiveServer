              ...
              >
                <div className="flex flex-1 flex-col gap-4 items-start justify-start my-0 w-full">
                  ...
                  <Text
                    ...
                    variant="body2"
                  >
                    Lorem ipsum dolor sit amet consectetur. Adipiscing justo
                    nunc mattis mus turpis urna purus. Eu eget lectus aenean
                    tincidunt vulputate et montes blandit. Proin turpis
                    adipiscing mollis elementum. Sed enim et commodo feugiat
                    magna.
                  </Text>
                  <Text
                    className="font-arboria leading-[33.00px] max-w-[1120px] md:max-w-full text-blue_gray_900"
