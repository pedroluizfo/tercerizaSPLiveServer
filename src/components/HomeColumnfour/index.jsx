    ...
    <>
      <div className={props.className}>
        <div className="flex flex-col items-start justify-start max-w-[1170px] w-full">
          ...
          <button onClick={(handleFaqData)} className="bg-blue_gray_900 flex sm:flex-col flex-row gap-4 items-start justify-start max-w-[1170px] sm:px-5 px-8 py-4 w-full">
            <Text
